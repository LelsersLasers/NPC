...
module.exports = {
	data: new SlashCommandBuilder()
		.setName("ping")
		.setDescription("Pings someone to get their attention (format: /ping [user] [times] [interval] [message])")
		...
		.addNumberOption(option =>
			option.setName("interval")
				.setDescription("The amount of time (in seconds) to wait between pings (default 5)")
				.setMinValue(1))
	...
	async execute(interaction) {
		...
		await interaction.reply("Pinging " + user.toString() + " " + times + " times with " + interval + " second intervals...");
